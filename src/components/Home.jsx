    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
            <div className='flex flex-col justify-center h-full '>
                ...
                As a self-taught front end developer with 1+ years of expierence, I have a passion for developing websites and applications that are both aesthetically pleasing and user-friendly. The essential knowledge and technology I have taught myself.
                </p>
                <div>
